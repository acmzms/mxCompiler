...
public class IRPrinter implements IIRVisitor {
    ...
    private String getNasmFunctionName(Function function) {
        switch (function.type) {
            case Library: return "__" + function.name;
            case External: return function.name;
            case UserDefined: return "_" + function.name;
            default: return null;
        }
    }
    ...
    @Override public void visit(BinaryInst inst) {
        String op = null;
        if ((inst.op == BinaryInst.BinaryOp.ADD || inst.op == BinaryInst.BinaryOp.SUB) &&
            inst.src instanceof Immediate && ((Immediate) inst.src).value == 0) {
            return;
        }
    ...
    @Override public void visit(UnaryInst inst) {
        String op = null;
        switch (inst.op) {
    ...
    @Override public void visit(Move inst) {
    ...
    @Override public void visit(Push inst) {
        append("\tpush ");
        inst.src.accept(this);
        append("\n");
    }
    @Override public void visit(Pop inst) {
        append("\tpop ");
        inst.dest.accept(this);
        append("\n");
    }
    @Override public void visit(CJump inst) {
        String op = null;
        switch (inst.op) {
            case E: op = "je"; break;
            case G: op = "jg"; break;
    ...
    @Override public void visit(Return inst) {
        append("\tret ");
        append("\n");
    }
    @Override public void visit(Call inst) {
        append("\tcall ");
    ...
    @Override public void visit(Leave inst) {
        append("\tleave\n");
    }
    @Override public void visit(Cdq inst) {
        append("\tcdq\n");
    }
