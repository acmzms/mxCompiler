...
class ASTscope
{
    ...
    public void visitProgramnode(programnode p)
    {
        ...
        f1.getparams().add(new declaration(new type("string"), new idnode("str", 0)));
        funcnode f2 = new funcnode("println", null);
        f2.settype(new type("void"));
        f2.getparams().add(new declaration(new type("string"), new idnode("str", 0)));
        ...
        f5.getparams().add(new declaration(new type("int"), new idnode("i", 0)));
        f1.seti(true);
        f2.seti(true);
        f3.seti(true);
        f4.seti(true);
        ...
        f7.getparams().add(new declaration(new type("int"), new idnode("left", 0)));
        f7.getparams().add(new declaration(new type("int"), new idnode("right", 0)));
        funcnode f8 = new funcnode("parseInt", null);
        f8.settype(new type("int"));
        funcnode f9 = new funcnode("ord", null);
        f9.settype(new type("int"));
        f9.getparams().add(new declaration(new type("int"), new idnode("pos", 0)));
        f6.seti(true);
        f7.seti(true);
        f8.seti(true);
        f9.seti(true);
